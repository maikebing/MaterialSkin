...
namespace MaterialSkin.Controls
{
	public class MaterialMenuStrip : MenuStrip, IMaterialControl
	{
		...
		protected override void OnCreateControl()
		{
			...
			BackColor = SkinManager.GetFlatButtonPressedBackgroundColor();
		}
	}
	...
	internal class MaterialMenuStripRender : ToolStripProfessionalRenderer, IMaterialControl
	{
		...
		protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
		{
			...
			{
				g.FillRectangle(e.Item.Selected ? SkinManager.GetFlatButtonPressedBackgroundBrush() : SkinManager.GetFlatButtonHoverBackgroundBrush(), itemRect);
			}
