...
namespace MaterialSkinExample
{
    public partial class LoginForm : MaterialForm
    {
        public LoginForm()
        {
            ...
            this.HamburgerClick += (sender, e) =>
            {
                //this.Hide();
                Win32.AnimateWindow(this.Handle, 300, Win32.AW_BLEND | Win32.AW_HIDE);
                ServiceCenterForm dialog = new ServiceCenterForm();
                dialog.Location = this.Location;
                dialog.Size = this.Size;
                dialog.Sizable = this.Sizable;
                dialog.MaximizeBox = false;
                Win32.AnimateWindow(dialog.Handle, 200, Win32.AW_CENTER | Win32.AW_BLEND);
                dialog.ShowDialog();
                this.Location = dialog.Location;
                this.Size = dialog.Size;
                Win32.AnimateWindow(this.Handle, 500, Win32.AW_BLEND | Win32.AW_ACTIVATE);
            };
        }
    }
    public class Win32
